...
class TogetherProvider(BaseLLMProvider):
    """Together AI provider for AI services."""
    ...
    async def generate_completion(self, prompt: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Together AI completion failed: {str(e)}")
    ...
    async def generate_embeddings(self, texts: List[str], **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            data = {
                "model": kwargs.get("embedding_model", "togethercomputer/m2-bert-80M-8k-retrieval"),
                "input": texts
            }
            ...
            if response.status_code != 200:
                raise Exception(f"Together AI embeddings API error: {response.status_code} - {response.text}")
            ...
            raise Exception(f"Together AI embeddings failed: {str(e)}")
    ...
    async def test_connection(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "error",
                "message": f"Together AI connection failed: {str(e)}"
            }
